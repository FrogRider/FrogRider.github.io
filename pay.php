...
<body>
    ...
    <div class="container">
        ...
        <div class="pay">
            ...
            <div class="panel">
              <p>Вы получаете посылку на отделение Новой Почты, или УкрПочты, проверяете товар и оплачиваете прямо на отделении. Важно: дополнительно оплачивается пересылка денег.</p>
            </div>
        </div>
