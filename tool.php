...
var img1 = "img/no-image.gif";
  ...
  if (id.charAt(0)) {
 id: for (var i = 0; i < products_tools.length; i++) {
     if (id === products_tools[i].id) {

      if (products_tools[i].img !== ""){
	      img1 = products_tools[i].img; 
	  }
	  if (products_tools[i].description !== ""){
	      description = products_tools[i].description; 
	  }
	  if (products_tools[i].name !== ""){
	      name = products_tools[i].name; 
	  }
	  if (products_tools[i].price !== ""){
